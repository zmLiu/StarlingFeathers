package dragonBones.objects
{
	...
	public class XMLDataParser
	{
		...
		private static function parseDisplayData(displayXML:XML, displayData:DisplayData):void
		{
			...
			displayData.pivotX = int(displayXML.attribute(ConstValues.A_PIVOT_X)) / _parseScale;
			displayData.pivotY = int(displayXML.attribute(ConstValues.A_PIVOT_Y)) / _parseScale;
		}
		...
		private static function parseNode(xml:XML, node:Node):void
		{
			...
			node.pivotX =  int(xml.attribute(ConstValues.A_PIVOT_X)) / _parseScale;
			node.pivotY =  int(xml.attribute(ConstValues.A_PIVOT_Y)) / _parseScale;
